      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto py-16 px-6">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            custom={0.3}
            className="bg-green-900 p-6 rounded-xl shadow-lg hover:shadow-yellow-500/10 transition"
          >
          ...
          <motion.div
            variants={fadeUp}
            custom={0.35}
            className="bg-green-900 rounded-xl shadow-lg overflow-hidden"
          >
            <iframe
        ...
        <motion.div
          ...
          variants={fadeUp}
          custom={0.6}
          className="bg-green-900 p-8 rounded-xl shadow-2xl"
        >
          ...
          <form className="space-y-5">
            <input
              ...
              className="w-full bg-green-800 border border-gray-700 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition"
            />
